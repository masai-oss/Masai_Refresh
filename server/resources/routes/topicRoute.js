...
topicRoute.post( "/create", authenticateToken, checkAdmin, upload.single("icon"), addTopic);
topicRoute.patch( "/icon/:id", authenticateToken, checkAdmin, upload.single("icon"), updateIcon);
