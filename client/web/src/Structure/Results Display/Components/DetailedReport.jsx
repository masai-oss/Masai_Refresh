...
const MyResponse = styled.div`
  ...
  & p{
    color: ${props => props.correct === 'skipped' ? '#efac00' : props.correct ? '#04a91e' : '#da0909'  };
    padding-left: 5px;
  }
`;
  ...
  return (
    ...
    <Response>
      <div>
        ...
        <MyResponse correct={ response !== 'skipped' ? correct === response : 'skipped' }>
          <p>{response}</p>
        </MyResponse>
      </div>
      <CorrectResponse>
      ...
      <Outcome>
        <Para>Outcome</Para>
        <Para>
          { response === 'skipped' ? <svg width="16" height="16" viewBox="0 0 41 25" xmlns="http://www.w3.org/2000/svg" fill="none"><path d="M39.9 12.9C39.1 12.2 37.9 12.2 37.1 12.9L32.4 17.6C31.6 9.6 25.7 2.7 17.4 1.1 11.3-0.1 5 1.8 0.6 6.1 -0.2 6.9-0.2 8.2 0.6 9 1.4 9.8 2.6 9.8 3.4 9 6.9 5.6 11.8 4.1 16.6 5 23.2 6.3 27.8 11.8 28.4 18.1L23.2 12.9C22.4 12.2 21.2 12.2 20.4 12.9 19.6 13.7 19.6 15 20.4 15.8L28.7 24.1C29.1 24.5 29.6 24.7 30.2 24.7 30.7 24.7 31.2 24.5 31.6 24.1L39.9 15.8C40.7 15 40.7 13.7 39.9 12.9Z" fill="#EFAC00"/></svg> : 
